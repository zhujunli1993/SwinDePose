...
testlist = np.loadtxt(os.path.join('/workspace/DATA/Occ_Linemod/data',args.cls_num,args.test_list),dtype='str')
...
# item_name = '0006'
    with Image.open(os.path.join('/workspace/DATA/Occ_Linemod/data',args.cls_num, "depth/{}.png".format(item_name))) as di:
        dpt_mm = np.array(di)
    
    # item_name = str(int(item_name))
    # meta = meta_lst[item_name]
    ...
    if args.vis_img:
        ...
        # # cv2.imwrite(img_file, rgb_s)
        # print('Please look at /workspace/DATA/Occ_Linemod/data/your_class/angles_or_signed_itemname.png')
        img_file = os.path.join('/workspace/DATA/Occ_Linemod/data',args.cls_num,'vis_nrm_angles_{}.png'.format(item_name))
    ...
    if not os.path.exists(os.path.join('/workspace/DATA/Occ_Linemod/data',args.cls_num,'pseudo_nrm_angles')):
        os.makedirs(os.path.join('/workspace/DATA/Occ_Linemod/data',args.cls_num,'pseudo_nrm_angles'))
    rgb_file = os.path.join('/workspace/DATA/Occ_Linemod/data',args.cls_num,'pseudo_nrm_angles','{}'.format(item_name))
