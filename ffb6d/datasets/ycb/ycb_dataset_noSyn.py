...
class Dataset():
    ...
    def __init__(self, dataset_name, DEBUG=False):
        ...
        if dataset_name == 'train':
            self.add_noise = True
            self.path = 'datasets/ycb/dataset_config/train_all.txt'
            ...
            self.path = 'datasets/ycb/dataset_config/test_all.txt'
            self.all_lst = bs_utils.read_lines(self.path)
    ...
    def get_item(self, item_name):
        ...
        # Use the second channel to replace the first depth channel, to remove the first depth channel and keep the size of channels is still three.
        # [angles_and_angles_and_signedAngles, h, w]
        #rgb[0,:,:] = rgb[1,:,:] # remove this line, it will use different three channels
        item_dict = dict(
