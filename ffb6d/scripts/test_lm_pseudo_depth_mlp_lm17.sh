...
GPU_NUM=4
GPU_COUNT=1
NAME='lm_17_pseudo_depth_mlp_noSyn_phone'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 50001 apps/train_lm_pseudo_depth_lm17.py \
    --gpus=$GPU_COUNT \
