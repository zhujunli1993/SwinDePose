...
GPU_NUM=4
GPU_COUNT=1
NAME='lm_swinTiny_iron_fullSyn_dense_fullInc'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 60017 apps/train_lm_nrmOnly_swinTiny_dense.py \
    --gpus=$GPU_COUNT \
