...
GPU_NUM=2
GPU_COUNT=1
NAME='lm_swinBase_phone_pbrRGB_dense_fullInc'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 60004 apps/train_lm_rgbPbr_swin_dense.py \
    --gpus=$GPU_COUNT \
