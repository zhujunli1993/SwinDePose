#!/bin/bash
GPU_NUM=0,1,2,3,4,6,7
GPU_COUNT=7
NAME='lm_10_pseudo_noSyn_depth_attention'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 50001 apps/train_lm_pseudo_depth_lm10.py \
    --gpus=$GPU_COUNT \
