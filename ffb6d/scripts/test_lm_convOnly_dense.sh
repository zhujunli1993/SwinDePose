...
GPU_NUM=4
GPU_COUNT=1
NAME='lm_convOnly_duck_fullSyn_dense_fullInc'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 60077 apps/train_lm_convOnly_dense.py \
    --gpus=$GPU_COUNT \
