...
GPU_NUM=7
GPU_COUNT=1
NAME='lm_swinTiny_ape_fullSyn_dense_fullInc_nrmVec'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 60099 apps/train_lm_nrmVec_swinTiny_dense.py \
    --gpus=$GPU_COUNT \
