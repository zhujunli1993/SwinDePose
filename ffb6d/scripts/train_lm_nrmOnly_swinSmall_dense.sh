...
GPU_NUM=7
GPU_COUNT=1
NAME='lm_swinSmall_ape_fullSyn_dense_fullInc'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 60023 apps/train_lm_nrmOnly_swinSmall_dense.py \
    --gpus=$GPU_COUNT \
