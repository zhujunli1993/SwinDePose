...
GPU_NUM=1
GPU_COUNT=1
NAME='lm_9_pseudo_noSyn_depth_RGB_mlp_2'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 50002 apps/train_lm_pseudo_depth_rgb_lm9.py \
    --gpus=$GPU_COUNT \
