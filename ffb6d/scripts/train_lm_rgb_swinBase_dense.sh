...
GPU_NUM=3
GPU_COUNT=1
NAME='lm_swinBase_phone_fullSynRGB_dense_fullInc'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 60008 apps/train_lm_rgb_swinBase_dense.py \
    --gpus=$GPU_COUNT \
