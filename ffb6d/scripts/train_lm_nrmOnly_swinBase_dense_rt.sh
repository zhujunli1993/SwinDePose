...
GPU_NUM=3
GPU_COUNT=1
NAME='lm_swinBase_nrmOnly_RT_noSeg'
...
python -m torch.distributed.launch --nproc_per_node=$GPU_COUNT --master_port 60003 apps/train_lm_nrmOnly_swinBase_dense_rt.py \
    --gpus=$GPU_COUNT \
    ...
    --linemod_cls=$CLS \
    --in_c 9 --lm_no_pbr --lm_no_fuse --lm_no_render \
