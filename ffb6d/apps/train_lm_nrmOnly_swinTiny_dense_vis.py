...
import datasets.linemod.linemod_dataset_nrmOnly_swin_dense_vis as dataset_desc
...
def model_fn_decorator(
    ...
    def model_fn(
        ...
        with torch.set_grad_enabled(not is_eval):
            ...
            #         data['nrm_angles'][:,0:3,:,:], img_id, 15, data['cld_angle_nrm'][0, :3, :],
            #         cu_dt['labels'].squeeze()
            #     )
            #     cv2.imwrite(os.path.join('/workspace/REPO/pose_estimation/ffb6d/'), show_gt_lb)
