...
from models.ffb6d_nrmOnly_swin import FFB6D
from models.loss import OFLoss, FocalLoss
from utils.pvn3d_eval_utils_kpls import TorchEval
from utils.basic_utils import Basic_Utils
import datasets.linemod.linemod_dataset_nrmOnly_swin as dataset_desc
...
def train():
    ...
    if not opt.eval_net:
        ...
        lr_scheduler = transformers.get_polynomial_decay_schedule_with_warmup(optimizer, 
                                        num_warmup_steps=train_ds.minibatch_per_epoch//clr_div, 
                                        num_training_steps=opt.n_total_epoch*train_ds.minibatch_per_epoch,
                                        lr_end=1e-3,
                                        power=1.0)
