...
from models.ffb6d_nrmOnly_swinBase_dense_rt import FFB6D
from models.loss import OFLoss, FocalLoss
import loss_rt
from utils.pvn3d_eval_utils_kpls import TorchEval
from utils.basic_utils import Basic_Utils
import datasets.linemod.linemod_dataset_nrmOnly_swin_dense_rt as dataset_desc
...
def model_fn_decorator(
    ...
    loss_fn = loss_rt.Loss(opt.losses, bs_utils, config, opt)
    teval = TorchEval()
    ...
    def model_fn(
        ...
        with torch.set_grad_enabled(not is_eval):
            ...
            loss_, loss_dict = loss_fn(end_points['pred_outputR'],
                            end_points['pred_outputT_est'],
                            cu_dt["RTs"],
                            cu_dt["K"],
                            labels,
                            points,
            ...
            if is_test and test_pose:
                ...
                if not opt.test_gt:
                    ...
                    add, adds, pred_kp, gt_kp, gt_ctr = teval.eval_pose_parallel(
                        ...
                        min_cnt=1, use_ctr_clus_flter=True, use_ctr=True,type="RT"
                    )
                # else:
