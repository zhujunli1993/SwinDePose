...
from models.cnn.pspnet_pseudo_depth_mlp import PSPNet
...
class FFB6D(nn.Module):
    def __init__(
        ...
        self.up_depth_oc=[512, 256, 64,64]
    ...
    def forward(
        ...
        for i_ds in range(4):
            ...
            rgb_emb0 = self.ds_fuse_fd_fuse_layers[i_ds](torch.cat((rgb_emb0,depth_emb0),dim=1))
