...
import models.cnn.extractors_pseudo_depth_rgb_crop_lm9 as extractors_pseudo_depth_rgb
...
class PSPNet(nn.Module):
    def __init__(
        ...
        self.up_1 = PSPUpsample(opt.psp_out*2, opt.up_rgb_oc[0])
        self.up_2 = PSPUpsample(opt.up_rgb_oc[0]*2, opt.up_rgb_oc[1])
        self.up_3 = PSPUpsample(opt.up_rgb_oc[1]*2, opt.up_rgb_oc[2])
        self.up_last = PSPUpsample(opt.up_rgb_oc[1], 64*2)
        self.drop_2 = nn.Dropout2d(p=0.15)
        self.final = nn.Sequential(
