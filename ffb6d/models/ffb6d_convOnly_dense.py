...
class CNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.layer1 = torch.nn.Sequential(
            torch.nn.Conv2d(3, 96, kernel_size=3, stride=1, padding=1),
            torch.nn.ReLU(),
        ...
        self.layer2 = torch.nn.Sequential(
            torch.nn.Conv2d(96, 192, kernel_size=3, stride=1, padding=1),
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(kernel_size=2, stride=2),
            torch.nn.Dropout(p=0.1))
        ...
        self.layer4 = torch.nn.Sequential(
            torch.nn.Conv2d(384, 768, kernel_size=3, stride=1, padding=1),
            torch.nn.ReLU(),
            torch.nn.MaxPool2d(kernel_size=2, stride=2, padding=1),
            torch.nn.Dropout(p=0.1))
...
class FFB6D(nn.Module):
    ...
    def forward(
        ...
        feat_nrm = self.cnn(inputs['nrm_angles'])
