...
class SwinTransformer(nn.Module):
    ...
    def __init__(
        ...
        img_ds_1: List[nn.Module] = []
        img_ds_2: List[nn.Module] = []
        img_ds_3: List[nn.Module] = []  
...
@register_model()
@handle_legacy_interface(weights=("pretrained", Swin_T_Weights.IMAGENET1K_V1))
def swin_ffb(*, weights: Optional[Swin_T_Weights] = None, progress: bool = True, **kwargs: Any) -> SwinTransformer:
    """
    Constructs a swin_tiny architecture from
    `Swin Transformer: Hierarchical Vision Transformer using Shifted Windows <https://arxiv.org/pdf/2103.14030>`_.
