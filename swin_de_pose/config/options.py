...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_exp.add_argument('--lab_vis', action='store_true', help='visualize lab results.')
        g_exp.add_argument('--lab_vis_input', type=str, help='the visualize backgound image for lab restuls')
        g_exp.add_argument('--lab_vis_output', type=str, help='the visualization for lab restuls')
        ...
        g_train.add_argument('--cyc_max_lr', type=float, default=1e-3, help="CyclicLR max learning rate [default: 1e-3]")
        g_train.add_argument('--cyc_base_lr', type=float, default=1e-5, help="CyclicLR base learning rate [default: 1e-5]")
        g_train.add_argument('--clr_div', type=float, default=6, help="CyclicLR scale [default: 6]")
